# Overview
It's a light color scheme made mostly from the [Monokai_Soda kitty theme](https://github.com/kovidgoyal/kitty-themes/blob/master/themes/Monokai_Soda.conf).

# Preview
The theme using 90% opacity:
